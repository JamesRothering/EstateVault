...
class DashboardTests(unittest.TestCase):
    ...
    def test_dashboard_loads_health_from_firefly_api(self):
        ...
        self.assertIn("30 / 60 / 90-day cash forecast", html)
        self.assertIn("data.forecast", html)
        self.assertIn("f.bills", html)
        self.assertIn("f.income", html)
        self.assertIn("f.net", html)
        self.assertIn("These numbers are estimates", html)
