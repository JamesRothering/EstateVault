...
2. On every open PR, workflow **Acceptance** starts Compose project `estatevault-review`: Firefly [http://127.0.0.1:8180](http://127.0.0.1:8180), Estate [http://127.0.0.1:8190](http://127.0.0.1:8190).
